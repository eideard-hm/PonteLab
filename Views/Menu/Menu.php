                        ...
                        <div class="user-tabing">
                            <ul class="nav nav-pills d-flex align-items-center justify-content-center profile-feed-items p-0 m-0">
                                <li class="col-6 p-0">
                                    ...
                                    <a href="<?= URL ?>Aspirante/Perfil_Aspirante" class="btn mt-3 mb-3 btn-primary" id="editar"><i class="far fa-user"></i>Ver perfil</a>
                                    <a href="<?= URL ?>Aspirante/Edit_Profile_Aspirante" class="btn mt-3 mb-3 btn-success"><i class="fas fa-user-edit"></i>Editar perfil</a>
                                    <a href="<?= URL ?>Aspirante/Aplicaciones_Vacante" class="btn mt-3 mb-3 btn-info"><i class="fas fa-clipboard-check"></i></i>Aplicaciones vacantes</a>
                                </li>
                                <li class="col-6 p-0">
