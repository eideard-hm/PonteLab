...
<body>
  ...
  <br>
  <p>
    <center>PONSLABOR te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación<br> o contratación de servicios a través del sitio Web DIRECCIÓN-WEB.

      En este sentido, PONSLABOR garantiza el cumplimiento de la normativa vigente en materia de protección de datos personales,<br>
  ...
  <br>
  <p>
    <center>En el tratamiento de tus datos personales, PONSLABOR aplica los siguientes principios que se ajustan a las exigencias del nuevo reglamento europeo de protección de datos: <br><br>
      ...
      <br><b>*Principio de minimización de datos:</b> PONSLABOR te solicitará solo los datos estrictamente necesarios para el fin o los fines que los solicita.
      <br><b>* Principio de integridad y confidencialidad:</b>Tus datos serán tratados de tal manera que su seguridad, confidencialidad e integridad esté garantizada. Debes saber que PONSLABOR toma las precauciones<br> necesarias para evitar el acceso no autorizado o uso indebido de los datos de sus usuarios por parte de terceros.
    </center>
  ...
  <br>
  <p>
    <center>PONSLABOR te informa que sobre tus datos personales tienes derecho a: <br>
