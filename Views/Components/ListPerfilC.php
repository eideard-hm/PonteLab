        ...
        <div class="iq-sub-dropdown iq-user-dropdown">
            <div class="iq-card shadow-none m-0">
                <div class="iq-card-body p-0 ">
                    ...
                    <a href="<?= URL ?>Contratante/Perfil_Contratante" class="iq-sub-card iq-bg-primary-hover">
                    ...
                    <a href="<?= URL ?>Contratante/Edit_Perfil_Contratante" class="iq-sub-card iq-bg-warning-hover">
                        <div class="media align-items-center">
