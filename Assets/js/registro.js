...
function validarCampos() {
  ...
  if (nombre === "" || email === "" || password === "") {
    ...
    swal(
      "Ups!",
      "La contraseña ingresada debe tener mas de 8 caracteres, mayusculas, minusculas y caracter especial",
      "error"
    );
    ...
    $(".next").click(function (e) {
      ...
      swal(
        "Correcto!",
        "Siguiente para continuar con el formulario",
        "success"
      );
      next_fs.show();
...
const insertUser = async () => {
  ...
  try {
    ...
    if (statusUser && msg === "ok") {
      ...
      swal(
        "Usuario",
        "Para continuar debe de confirmar su cuenta a través de su correo electrónico. Gracias por preferir nuestros servicios :)",
        "success"
      );
  ...
  try {
    ...
    if (status) {
      ...
      setTimeout(() => {
        ...
        swal(
          "Usuario",
          "No te olvides de confirmar tu cuenta a través de tu correo eletronico. Gracias por preferirnos; PonteLab tu mejor opción de bolsa de empleo.",
          "info"
        );
      }, 5000);
    } else {
